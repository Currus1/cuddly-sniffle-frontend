    ...
    return (
        <>
            <div className='userInputContainer'>
                ...
                <div>
                    <button onClick={SaveClicked} style={{margin: '10px 10px'}} className='button-save'>Save</button>
                    <button onClick={LoadClicked} style={{margin: '10px 10px'}} className='button-planning'>Load</button>
                </div>
            </div>
